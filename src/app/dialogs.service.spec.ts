...
describe('DialogsService', () => {
  ...
  it('should be able to open openComments dialog', () => {
    const service: DialogsService = TestBed.get(DialogsService);
    expect(service.openCommentsDialog).toBeTruthy();
  });

  it('should be able to open delete marker indication dialog', () => {
    const service: DialogsService = TestBed.get(DialogsService);
    expect(service.openDeleteMarkerDialog).toBeTruthy();
  });

  it('should be able to open help dialog', () => {
    const service: DialogsService = TestBed.get(DialogsService);
    expect(service.openHelpDialog).toBeTruthy();
  });

  it('should be able to open configurations dialog', () => {
    const service: DialogsService = TestBed.get(DialogsService);
    expect(service.openConfigurationDialog).toBeTruthy();
  });
});
