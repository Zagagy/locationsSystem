...
describe('StylesService', () => {
  ...
  it('should be able to get the current map style', () => {
    const service: StylesService = TestBed.get(StylesService);
    expect(service.getMapStyle).toBeTruthy();
  });

  it('should be able to get the current background color', () => {
    const service: StylesService = TestBed.get(StylesService);
    expect(service.getBackgroundColor).toBeTruthy();
  });

  it('should be able to get valid themes', () => {
    const service: StylesService = TestBed.get(StylesService);
    expect(service.getThemes).toBeTruthy();
  });
});
